...
export const URLSessionFormPresenter: FC<Props> = ({
  ...
  const handleFetchSchema = async () => {
    ...
    try {
      ...
      handleSchemaError('An error occurred while fetching the schema')
    }
  }
          ...
          {schemaStatus !== 'idle' && (
            <SchemaInfoSection
              ...
              onViewTroubleshootingGuide={() => {
                // In a real app, this would navigate to troubleshooting docs
                window.open(
                  'https://liam-docs.com/troubleshooting/schema-errors',
                  '_blank',
                )
              }}
            />
