...
import { PasteSchemaSessionFormPresenter } from './PasteSchemaSessionFormPresenter'

type Props = Record<string, never>

export const PasteSchemaSessionForm: FC<Props> = () => {
  ...
  return (
    <PasteSchemaSessionFormPresenter
