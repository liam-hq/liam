...
export const PublicSessionDetailPage: FC<Props> = async ({
  ...
  // Check if the session is publicly shared
  ...
  // Fetch design session data using public views
  ...
  const { data: versions } = await supabase
    .from('building_schema_versions_public')
    .select('*')
