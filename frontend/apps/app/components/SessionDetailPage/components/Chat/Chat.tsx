...
export const Chat: FC<Props> = ({
  ...
  const [isDeepModelingEnabledState, setIsDeepModelingEnabledState] = useState(isDeepModelingEnabled)
  ...
  const startAIResponse = async (content: string) => {
    ...
    await sendChatMessage({
      designSessionId,
      userInput: content,
      isDeepModelingEnabled: isDeepModelingEnabledState,
    })
  }
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <ChatInput
        ...
        schema={schemaData}
        isDeepModelingEnabled={isDeepModelingEnabledState}
        onDeepModelingToggle={setIsDeepModelingEnabledState}
      />
    </div>
  )
}
