...
export type Database = {
    ...
    public: {
        Tables: {
            ...
            timeline_items: {
                Row: {
                    assistant_role: Database['public']['Enums']['assistant_role_enum'] | null;
        ...
        Enums: {
            ...
            timeline_item_type_enum: 'user' | 'assistant' | 'schema_version' | 'error' | 'assistant_log' | 'query_result';
...
export declare const Constants: {
    ...
    readonly public: {
        readonly Enums: {
            readonly assistant_role_enum: readonly ["db", "pm", "qa"];
            readonly category_enum: readonly ["MIGRATION_SAFETY", "DATA_INTEGRITY", "PERFORMANCE_IMPACT", "PROJECT_RULES_CONSISTENCY", "SECURITY_OR_SCALABILITY"];
            readonly knowledge_type: readonly ["SCHEMA", "DOCS"];
            readonly schema_format_enum: readonly ["schemarb", "postgres", "prisma", "tbls"];
            readonly severity_enum: readonly ["CRITICAL", "WARNING", "POSITIVE", "QUESTION"];
            readonly timeline_item_type_enum: readonly ["user", "assistant", "schema_version", "error", "assistant_log", "query_result"];
            readonly workflow_run_status: readonly ["pending", "success", "error"];
        };
    };
};
export {};
