...
CREATE POLICY "public_building_schema_versions_public_read" ON "public"."building_schema_versions_public" FOR SELECT TO "anon" USING (("building_schema_id" IN ( SELECT "bs"."id"
   FROM "public"."building_schemas" "bs"
  WHERE ("bs"."design_session_id" IN ( SELECT "public_share_settings"."design_session_id"
           FROM "public"."public_share_settings")))));


CREATE POLICY "public_building_schemas_public_read" ON "public"."building_schemas_public" FOR SELECT TO "anon" USING (("design_session_id" IN ( SELECT "public_share_settings"."design_session_id"
   FROM "public"."public_share_settings")));


CREATE POLICY "public_design_sessions_public_read" ON "public"."design_sessions_public" FOR SELECT TO "anon" USING (("id" IN ( SELECT "public_share_settings"."design_session_id"
   FROM "public"."public_share_settings")));


CREATE POLICY "public_timeline_items_public_read" ON "public"."timeline_items_public" FOR SELECT TO "anon" USING (("design_session_id" IN ( SELECT "public_share_settings"."design_session_id"
   FROM "public"."public_share_settings")));
