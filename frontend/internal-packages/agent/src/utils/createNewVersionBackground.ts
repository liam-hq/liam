...
import { createBackgroundClient } from '../db/background'
...
/**
 * Create a new version for background jobs (without cookies)
 * This version uses the service role client to bypass RLS
 */
export async function createNewVersionBackground({
  buildingSchemaId,
  latestVersionNumber,
  patch,
