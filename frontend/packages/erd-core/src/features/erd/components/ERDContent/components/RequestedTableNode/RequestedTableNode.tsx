...
import { TableColumnList } from '../TableNode/TableColumnList'
import { TableHeader } from '../TableNode/TableHeader'
import styles from './RequestedTableNode.module.css'

type Props = NodeProps<TableNodeType>

export const RequestedTableNode: FC<Props> = ({ data }) => {
