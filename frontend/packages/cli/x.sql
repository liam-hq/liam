...
INSERT INTO meta.migrations VALUES ('202407160001', 'embeddings', '2025-07-10 10:32:19.692+00');
...
ALTER TABLE ONLY public.regions
    ADD CONSTRAINT regions_pkey PRIMARY KEY (country_code, region_code);
...
--
-- Name: stores fk_store_region; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.stores
    ADD CONSTRAINT fk_store_region FOREIGN KEY (country_code) REFERENCES public.regions(country_code) ON DELETE CASCADE;
