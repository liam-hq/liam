...
CREATE INDEX "idx_db_engines_github_repository_id" ON "public"."db_engines" USING "btree" ("github_repository_id");



CREATE INDEX "idx_migration_files_github_repository_id" ON "public"."migration_files" USING "btree" ("github_repository_id");
...
ALTER TABLE ONLY "public"."db_engines"
    ADD CONSTRAINT "db_engines_github_repository_id_fkey" FOREIGN KEY ("github_repository_id") REFERENCES "public"."github_repositories"("id") ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."migration_files"
    ADD CONSTRAINT "migration_files_github_repository_id_fkey" FOREIGN KEY ("github_repository_id") REFERENCES "public"."github_repositories"("id") ON UPDATE CASCADE ON DELETE RESTRICT;
...
CREATE POLICY "authenticated_users_can_delete_org_db_engines" ON "public"."db_engines" FOR DELETE TO "authenticated" USING (("github_repository_id" IN ( SELECT "prm"."repository_id"
   FROM (("public"."project_repository_mappings" "prm"
     JOIN "public"."projects" "p" ON (("prm"."project_id" = "p"."id")))
...
CREATE POLICY "authenticated_users_can_delete_org_migration_files" ON "public"."migration_files" FOR DELETE TO "authenticated" USING (("github_repository_id" IN ( SELECT "prm"."repository_id"
   FROM (("public"."project_repository_mappings" "prm"
     JOIN "public"."projects" "p" ON (("prm"."project_id" = "p"."id")))
     JOIN "public"."organization_members" "om" ON (("p"."organization_id" = "om"."organization_id")))
  WHERE ("om"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "authenticated_users_can_insert_org_db_engines" ON "public"."db_engines" FOR INSERT TO "authenticated" WITH CHECK (("github_repository_id" IN ( SELECT "prm"."repository_id"
   FROM (("public"."project_repository_mappings" "prm"
     JOIN "public"."projects" "p" ON (("prm"."project_id" = "p"."id")))
     JOIN "public"."organization_members" "om" ON (("p"."organization_id" = "om"."organization_id")))
  WHERE ("om"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "authenticated_users_can_insert_org_migration_files" ON "public"."migration_files" FOR INSERT TO "authenticated" WITH CHECK (("github_repository_id" IN ( SELECT "prm"."repository_id"
   FROM (("public"."project_repository_mappings" "prm"
     JOIN "public"."projects" "p" ON (("prm"."project_id" = "p"."id")))
     JOIN "public"."organization_members" "om" ON (("p"."organization_id" = "om"."organization_id")))
  WHERE ("om"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "authenticated_users_can_select_org_db_engines" ON "public"."db_engines" FOR SELECT TO "authenticated" USING (("github_repository_id" IN ( SELECT "prm"."repository_id"
   FROM (("public"."project_repository_mappings" "prm"
     JOIN "public"."projects" "p" ON (("prm"."project_id" = "p"."id")))
     JOIN "public"."organization_members" "om" ON (("p"."organization_id" = "om"."organization_id")))
  WHERE ("om"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "authenticated_users_can_select_org_migration_files" ON "public"."migration_files" FOR SELECT TO "authenticated" USING (("github_repository_id" IN ( SELECT "prm"."repository_id"
   FROM (("public"."project_repository_mappings" "prm"
     JOIN "public"."projects" "p" ON (("prm"."project_id" = "p"."id")))
     JOIN "public"."organization_members" "om" ON (("p"."organization_id" = "om"."organization_id")))
  WHERE ("om"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "authenticated_users_can_update_org_db_engines" ON "public"."db_engines" FOR UPDATE TO "authenticated" USING (("github_repository_id" IN ( SELECT "prm"."repository_id"
   FROM (("public"."project_repository_mappings" "prm"
     JOIN "public"."projects" "p" ON (("prm"."project_id" = "p"."id")))
     JOIN "public"."organization_members" "om" ON (("p"."organization_id" = "om"."organization_id")))
  WHERE ("om"."user_id" = "auth"."uid"())))) WITH CHECK (("github_repository_id" IN ( SELECT "prm"."repository_id"
   FROM (("public"."project_repository_mappings" "prm"
     JOIN "public"."projects" "p" ON (("prm"."project_id" = "p"."id")))
     JOIN "public"."organization_members" "om" ON (("p"."organization_id" = "om"."organization_id")))
  WHERE ("om"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "authenticated_users_can_update_org_migration_files" ON "public"."migration_files" FOR UPDATE TO "authenticated" USING (("github_repository_id" IN ( SELECT "prm"."repository_id"
   FROM (("public"."project_repository_mappings" "prm"
     JOIN "public"."projects" "p" ON (("prm"."project_id" = "p"."id")))
     JOIN "public"."organization_members" "om" ON (("p"."organization_id" = "om"."organization_id")))
  WHERE ("om"."user_id" = "auth"."uid"())))) WITH CHECK (("github_repository_id" IN ( SELECT "prm"."repository_id"
