...
ALTER TABLE ONLY "public"."db_engines"
    ADD CONSTRAINT "db_engines_github_repository_id_fkey" 
    FOREIGN KEY ("github_repository_id") 
    REFERENCES "public"."github_repositories"("id") 
    ON UPDATE CASCADE ON DELETE RESTRICT;

ALTER TABLE ONLY "public"."migration_files"
    ADD CONSTRAINT "migration_files_github_repository_id_fkey" 
    FOREIGN KEY ("github_repository_id") 
    REFERENCES "public"."github_repositories"("id") 
    ON UPDATE CASCADE ON DELETE RESTRICT;
...
CREATE POLICY "authenticated_users_can_select_org_db_engines" 
  ...
  USING (("github_repository_id" IN ( 
    SELECT "prm"."repository_id"
...
CREATE POLICY "authenticated_users_can_insert_org_db_engines" 
  ...
  WITH CHECK (("github_repository_id" IN ( 
    SELECT "prm"."repository_id"
    FROM "public"."project_repository_mappings" "prm"
    JOIN "public"."projects" "p" ON "prm"."project_id" = "p"."id"
    JOIN "public"."organization_members" "om" ON "p"."organization_id" = "om"."organization_id"
